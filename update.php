...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($input_name)){
        $name_err = "Please enter the course name.";
    ...
    if(empty($name_err) && empty($course_code_err)){
        ...
        $sql = "UPDATE courses SET name=?, course_code=? WHERE id=?";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ssi", $param_name, $param_course_code,  $param_id);
